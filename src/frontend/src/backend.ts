...
export class Backend implements backendInterface {
    ...
    async createMemory(arg0: NewMemoryInput): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getMemoriesByLocation(arg0: string): Promise<Array<MemoryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemoriesByLocation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemoriesByYear(arg0: bigint): Promise<Array<MemoryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemoriesByYear(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemoriesCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemoriesCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemory(arg0: bigint): Promise<MemoryEntry> {
        if (this.processError) {
            try {
    ...
    async getOnThisDayMemories(arg0: bigint, arg1: bigint): Promise<Array<MemoryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOnThisDayMemories(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isMemoryStoreEmpty(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isMemoryStoreEmpty();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMemory(arg0: bigint, arg1: NewMemoryInput): Promise<void> {
        if (this.processError) {
            try {
